...
class ClientController {
    ...
    // 'pending' is GENERATED ALWAYS AS (contract_value - paid) STORED
    private const GENERATED_COLS = ['pending'];
    ...
    public function create() {
        try {
            ...
            foreach (self::GENERATED_COLS as $col) {
                unset($input[$col]);
            }
    ...
    public function update($id) {
        try {
            ...
            // Strip generated columns so MySQL doesn't throw an error
            foreach (self::GENERATED_COLS as $col) {
                unset($input[$col]);
            }
