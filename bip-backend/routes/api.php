...
return [
    ...
    // Product Routes — literal route MUST come before {id} wildcard
    ...
    // Salary Routes — literal /summary MUST come before {id} wildcard
    ...
    // Attendance Routes — literal /stats MUST come before {id} wildcard
